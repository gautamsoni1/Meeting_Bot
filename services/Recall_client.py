...
#     """Fetch full bot object — includes recordings list."""
...
#     """
#     Correct approach per Recall docs:
#     1. GET /bot/{bot_id}/
#     2. Look inside recordings[0].media_shortcuts.audio_mixed_mp3
#     3. Check status.code == 'done'
#     4. Return data.download_url
#     """
#     bot = get_bot(bot_id)
...
#         # ✅ Correct path per Recall Download Schemas docs
#         media_shortcuts = recording.get("media_shortcuts", {})
#         # CORRECT — matches actual Recall.ai response
#         audio = media_shortcuts.get("audio_mixed")

#         if not audio:
#             print("   ⚠️  audio_mixed_mp3 not in media_shortcuts yet")
#             continue

#         status_code = audio.get("status", {}).get("code")
#         print(f"   audio_mixed_mp3 status = {status_code}")
...
#             return download_url
#         else:
#             print(f"   ⏳ audio_mixed_mp3 not ready yet (status={status_code})")
